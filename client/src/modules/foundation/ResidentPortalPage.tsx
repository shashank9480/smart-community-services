    ...
    <div className="space-y-8 animate-in fade-in duration-200">
      ...
      <div className="p-8 rounded-2xl bg-gradient-to-r from-emerald-900 via-emerald-850 to-slate-900 text-white shadow-xl border border-emerald-800/80 relative overflow-hidden">
        ...
        <div className="relative z-10 flex flex-col md:flex-row items-start md:items-center justify-between gap-6">
          <div>
            <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-emerald-500/20 text-emerald-300 text-xs font-mono font-medium mb-3 border border-emerald-500/30">
          ...
          <div className="p-4 rounded-xl bg-black/30 backdrop-blur-md border border-white/10 shrink-0 font-mono text-center min-w-[180px]">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          <NavLink to="/resident/passes">
            <Card
              ...
              className="hover:border-emerald-400 transition-all cursor-pointer h-full"
            >
          ...
          <NavLink to="/resident/staff">
            <Card
              ...
              action={<Badge variant="success">Active Module</Badge>}
              className="hover:border-blue-400 transition-all cursor-pointer h-full"
            >
              <p className="text-sm text-slate-600 mb-4">
          ...
          <NavLink to="/resident/invoices">
            <Card
              ...
              action={<Badge variant="success">Active Module</Badge>}
              className="hover:border-amber-400 transition-all cursor-pointer h-full"
            >
              <p className="text-sm text-slate-600 mb-4">
          ...
          <NavLink to="/resident/tickets">
            <Card
              ...
              action={<Badge variant="success">Active Module</Badge>}
              className="hover:border-purple-400 transition-all cursor-pointer h-full"
            >
              <p className="text-sm text-slate-600 mb-4">
          ...
          <NavLink to="/resident/community">
            <Card
              ...
              className="hover:border-red-400 transition-all cursor-pointer h-full"
            >
              <p className="text-sm text-slate-600 mb-4">
              ...
              <div className="flex items-center justify-between pt-3 border-t border-slate-100 text-xs font-mono text-slate-500">
                <span className="flex items-center gap-1.5"><AlertCircle className="w-4 h-4 text-red-600" /> Live Radar Broadcast</span>
