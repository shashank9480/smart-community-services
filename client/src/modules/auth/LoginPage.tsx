...
export const LoginPage: React.FC = () => {
  ...
  return (
    <div className="min-h-screen grid lg:grid-cols-2 bg-slate-950 text-slate-100 selection:bg-emerald-500 selection:text-white relative overflow-hidden">
      {/* Ambient glowing background orbs */}
      <div className="absolute top-10 left-10 w-96 h-96 bg-emerald-500/10 rounded-full blur-3xl pointer-events-none animate-float-slow" />
      <div className="absolute bottom-10 right-10 w-96 h-96 bg-blue-500/10 rounded-full blur-3xl pointer-events-none animate-float-reverse" />

      {/* Left Column: Brand & Avionics Concept Hero */}
      <div className="relative hidden lg:flex flex-col justify-between p-12 overflow-hidden border-r border-slate-800/80 bg-gradient-to-b from-slate-950 via-slate-900 to-slate-950 z-10">
        ...
        >
          <motion.div
            ...
            className="w-10 h-10 rounded-xl bg-emerald-600 flex items-center justify-center font-bold text-white shadow-lg shadow-emerald-500/30 cursor-pointer"
          >
            SCS
          </motion.div>
          <div>
        ...
        >
          <div className="inline-flex items-center gap-2 px-3 py-1.5 rounded-full bg-emerald-950/80 border border-emerald-800/80 text-emerald-300 text-xs font-mono font-medium shadow-sm">
          ...
          <div className="grid grid-cols-2 gap-4 pt-4 border-t border-slate-800/80 font-mono text-xs">
            <motion.div whileHover={{ y: -2 }} className="p-3 rounded-lg bg-slate-900/80 border border-slate-800 shadow-sm">
      ...
      <div className="flex flex-col justify-center items-center p-6 sm:p-12 bg-slate-900/40 z-10">
        <motion.div
          initial={{ opacity: 0, scale: 0.95, y: 15 }}
          animate={{ opacity: 1, scale: 1, y: 0 }}
          transition={{ duration: 0.4, ease: [0.25, 0.1, 0.25, 1] }}
          className="w-full max-w-md space-y-8 bg-white text-slate-900 p-8 sm:p-10 rounded-2xl shadow-2xl border border-slate-200"
        >
          <div>
          ...
          {error && (
            <motion.div
              ...
              animate={{ opacity: 1, y: 0 }}
              className="p-3.5 rounded-lg bg-red-50 border border-red-200 text-red-700 text-xs font-medium flex items-start gap-2.5 shadow-sm"
            >
          ...
          <div className="pt-6 border-t border-slate-200">
            ...
            <div className="grid grid-cols-2 gap-2 font-mono text-xs">
              <motion.button
                ...
                className="p-2.5 rounded-lg border border-slate-200 bg-slate-50 hover:bg-emerald-50 hover:border-emerald-300 text-left transition-colors group flex flex-col justify-between"
              >
              ...
              <motion.button
                ...
                className="p-2.5 rounded-lg border border-slate-200 bg-slate-50 hover:bg-amber-50 hover:border-amber-300 text-left transition-colors group flex flex-col justify-between"
              >
