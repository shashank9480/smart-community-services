...
// ==========================================
// PAGE 1: SYNOPSIS COVER PAGE
// ==========================================
htmlPages.push(makeCoverPage(1, "SYNOPSIS"));

// ==========================================
// PAGE 2: SYNOPSIS PAGE 1
// ==========================================
...
// ==========================================
// PAGE 4: INTRODUCTION COVER PAGE
// ==========================================
htmlPages.push(makeCoverPage(4, "INTRODUCTION"));

// ==========================================
// PAGE 5: INTRODUCTION PAGE 1
// ==========================================
...
// ==========================================
// PAGE 7: OBJECTIVE COVER PAGE
// ==========================================
htmlPages.push(makeCoverPage(7, "OBJECTIVE"));

// ==========================================
// PAGE 8: OBJECTIVE PAGE 1
// ==========================================
...
htmlPages.push(makePage(11, `
  ...
  <p>The software environment used to develop and execute the platform includes:</p>
  ...
  <table>
    ...
    <tbody>
      ...
      <tr>
        <td><strong>Documentation & Reports</strong></td>
...
// ==========================================
// PAGE 12: SOFTWARE ENVIRONMENT PAGE 2
// ==========================================
...
// ==========================================
// PAGE 14: FRONTEND Continued & Components
// ==========================================
...
// ==========================================
// PAGE 16: BACKEND Capabilities & Features
// ==========================================
...
// ==========================================
// PAGE 17: DATABASE Prisma & SQLite
// ==========================================
...
// ==========================================
// PAGE 19: FRONTEND & BACKEND SUMMARY
// ==========================================
...
// ==========================================
// PAGE 20: SYSTEM DESIGN COVER PAGE
// ==========================================
htmlPages.push(makeCoverPage(20, "SYSTEM DESIGN"));

// ==========================================
// PAGE 21: ER DIAGRAM DEFINITIONS
// ==========================================
...
// ==========================================
// PAGE 22: ER DIAGRAM SYMBOLS TABLE
// ==========================================
...
// ==========================================
// PAGE 23: ER DIAGRAM ARCHITECTURE
// ==========================================
...
// ==========================================
// PAGE 24: DFD DEFINITIONS & SYMBOLS
// ==========================================
...
// ==========================================
// PAGE 26: IMPLEMENTATION COVER PAGE
// ==========================================
htmlPages.push(makeCoverPage(26, "IMPLEMENTATION"));

// ==========================================
// PAGE 27: IMPLEMENTATION DETAILS
// ==========================================
...
// ==========================================
// PAGE 28: CODES AND SCREENSHOTS COVER PAGE
// ==========================================
htmlPages.push(makeCoverPage(28, "CODES AND SCREENSHOTS"));

// ==========================================
// PAGE 29-35: CODE SNIPPETS (Prisma Schema, Server Index, Auth Controller)
// ==========================================
...
// Generate Pages 36-75 code placeholders so code section matches length cleanly
for (let p = 36; p <= 75; p++) {
...
// ==========================================
// PAGE 76: SCREENSHOTS COVER PAGE & PAGE 1
// ==========================================
htmlPages.push(makeCoverPage(76, "SCREENSHOTS"));

// ==========================================
// PAGE 77: SCREENSHOTS - HOME PAGE & LOGIN PAGE
// ==========================================
...
// ==========================================
// PAGE 78: SCREENSHOTS - ADMIN COMMAND CENTRE
// ==========================================
...
// ==========================================
// PAGE 79: SCREENSHOTS - RESIDENT PORTAL & VISITOR PASS
// ==========================================
...
// ==========================================
// PAGE 80: SCREENSHOTS - GUARD CONSOLE & PASS VERIFICATION
// ==========================================
...
// ==========================================
// PAGE 81: SCREENSHOTS - GUARD SOS RADAR
// ==========================================
...
// ==========================================
// PAGE 82: SCREENSHOTS - MAINTENANCE INVOICE
// ==========================================
...
// ==========================================
// PAGE 83: SCREENSHOTS - HELPDESK TICKET QUEUE
// ==========================================
...
// Assemble complete HTML document string
...
console.log("Successfully generated PROJECT_REPORT.html");
